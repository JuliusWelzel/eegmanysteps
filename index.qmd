...
The issues stem from more fundamental structural problems in academia, including the lack of occupational stability of researchers themselves or funding for hiring professional developers. The effect is amplified by the lack of hands-on training opportunities and the insufficient incentives for maintaining open-source software tools, despite the science community’s high reliance on them. The psychological dynamics surrounding these issues are equally important, as they influence how researchers perceive and engage with OS practices. While the actionable solutions to the structural problems are elusive from the perspective of an early career researcher, we are committed to being vocal about the issues and fostering an environment where OS is the norm, in addition to making tangible contributions to the extent possible.
