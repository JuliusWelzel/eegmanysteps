...
graph LR
    ...
    style B0 fill:#E8E8E8,stroke:#555,stroke-width:3px,corner-radius:5px
    ...
    B0[WP0: Define Goals]
    B2[WP1: Experiment Protocols<br>and Data Collection]
    B3[WP2: Data Curation]
    B4[WP3: Preprocessing]
    B5[WP4: Analysis]
